...
class AdditionServiceClient implements \add\AdditionServiceIf {
  ...
  {
    $args = new \add\AdditionService_add_args();
    $args->n1 = $n1;
    $args->n2 = $n2;
  ...
  public function recv_add()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\add\AdditionService_add_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \add\AdditionService_add_result();
...
class AdditionService_add_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'AdditionService_add_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AdditionService_add_result');
